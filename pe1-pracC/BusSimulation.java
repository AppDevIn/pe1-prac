...
class BusSimulation extends Simulation {
  ...
  public BusSimulation(Scanner sc) {
    ...
    for (int i = 0; i < numBuses; i++) {
      ...
      // TODO
      initEvents[id] = new BusStopEvent(leaveTime, buses[i], new Soc(this.stops));
      id += 1;
    }
    ...
    while (sc.hasNextDouble()) {
      ...
      // TODO
      initEvents[id] = new ArrivalEvent(arrivalTime, new Passenger(destination), this.stops[source]);
      id += 1;
    }
  }
